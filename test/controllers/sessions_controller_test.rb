...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "perform user login" do
    post session_path, params: {name: 'glenn.goodrich@sitepoint.com', password: 'sekrit'}
    assert_redirected_to events_path
    assert_equal users(:glenn).id, session[:user_id]
  end

  test "bad login fails" do
    post session_path, params: {name: 'noone@nowhere.com', password: 'user'}
    assert_response :success
  ...
  test "redirects after login with return url" do
    ...
    post session_path,
      params: {
        name: 'glenn.goodrich@sitepoint.com',
        password: 'sekrit'
      }
  ...
  test "logout and clear session" do
    post(
      session_path,
      params: { name: 'glenn.goodrich@sitepoint.com', password: 'sekrit' }
    )
